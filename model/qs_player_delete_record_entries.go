...
JSON Sample
-------------------------------------
{    "event_id": 91,    "item_id": 99,    "aug_1": 87,    "aug_2": 79,    "aug_3": 76,    "aug_4": 61,    "char_slot": 16,    "charges": 34,    "aug_5": 0}


Comments
-------------------------------------
[ 0] Warning table: qs_player_delete_record_entries does not have a primary key defined, setting col position 1 event_id as primary key
Warning table: qs_player_delete_record_entries primary key column event_id is nullable column, setting it as NOT NULL
...
var qs_player_delete_record_entriesTableInfo = &TableInfo{
	Name: "qs_player_delete_record_entries",
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			Name:    "event_id",
			Comment: ``,
			Notes: `Warning table: qs_player_delete_record_entries does not have a primary key defined, setting col position 1 event_id as primary key
Warning table: qs_player_delete_record_entries primary key column event_id is nullable column, setting it as NOT NULL
`,
			Nullable:           false,
...
func (q *QsPlayerDeleteRecordEntries) TableName() string {
	return "qs_player_delete_record_entries"
}
...
func (q *QsPlayerDeleteRecordEntries) TableInfo() *TableInfo {
	return qs_player_delete_record_entriesTableInfo
}
